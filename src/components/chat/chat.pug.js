...
;pug_debug_line = 5;pug_debug_filename = "src\u002Fcomponents\u002Fchat\u002Fchat.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = messageObj.nickname) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
;pug_debug_line = 6;pug_debug_filename = "src\u002Fcomponents\u002Fchat\u002Fchat.pug";
pug_html = pug_html + "\n      \u003Cp\u003E";
;pug_debug_line = 6;pug_debug_filename = "src\u002Fcomponents\u002Fchat\u002Fchat.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = messageObj.text) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\n    \u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
